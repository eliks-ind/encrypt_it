...
function App() {
  ...
  return (
    <div className="App">
      ...
      <main className="main">
      <input type="textarea" className="input_text" name="text" placeholder="Enter the text..." />
      <br></br>
      <div className="buttons">
        <button className="encrypt_button" type="button" onClick={encrypt}>Encrypt</button>
        <button className="decrypt_button" type="button" onClick={decrypt}>Decrypt</button>
      </div>
